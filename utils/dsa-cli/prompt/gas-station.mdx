...
First we convert them all in a format of gains:

![](./../../../img/2023-09-19-21-04-00.png)

Then you can intuitivelly think that you wouldnt start from somewhere where the gain is negative. You could think the same as for the "segment that lead you to that path"
