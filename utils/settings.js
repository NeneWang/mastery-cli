module.exports = Settings = {
    ...
    Don't learn something new until the current project is maximized. \n Money will come naturally when you have strong craftmanship. be so good, that you wont be ignored.",
    // Reporting
    "report_show": {
    ...
    "table_feat_show": ["commits", "feat", "algo_w", "pro"], // commits │ feat │ math_ss │ ref │ fix  │ algo │ acad │ pro  │ terms │ algo_w │ test │ tesrasd │ commits} │ terms}
    "objectives_features": [
        {
            "feature_key": "commits",
