...
const business_marketing = [
    ...
    {formula_name: "bus-roi", "form": `Y = (ld_1 - ld_2)/ ld_2`, "replace": ['ld_1', 'ld2'], "calculates": ["y"], "ans_constraint": ".0", "human": `Calculate ROI (Return of Investment): \nnGain from Investments: ld_1\n Cost of Investment: ld_2\n` },
    {formula_name: "bus-retention", "form": `Y = (d_1 - md_2) / d_3`, "replace": ['d_1', 'md_2', 'd_3'], "calculates": ["y"], "ans_constraint": ".1", "human": `Calculate customer retention rate: \nCustomers at the beginning of the year: d_3\n adquires md_2 this year\n and at the end of the year has d_1 customers\n` },
