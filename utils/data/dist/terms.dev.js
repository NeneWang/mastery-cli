 ...
 */
var _require = require('./react_terms'),
    react_terms = _require.react_terms;

var _require2 = require("./fall23"),
    network = _require2.network,
    artificialIntelligence = _require2.artificialIntelligence,
    algebra = _require2.algebra,
    calculousOne = _require2.calculousOne;

var _require3 = require('./ethics.js'),
    pragmatic_programmer = _require3.pragmatic_programmer;

var _require4 = require('../structures'),
    TermStorage = _require4.TermStorage;
...
var unit_testing = [{
  ...
  description: "For example you have a code with logs of logic and time to setup, or also an ",
  example: "You can break it down into Factory pattern to build the objects, (with those preconditions)"
}, {
  ...
  description: "Logging should only be done only if is a business requirement",
  ...
  description: "Managed dependencies are dependencies that are directly controlled and managed by a package manager (e.g. npm, pip, gem, etc.). These dependencies are installed and updated automatically when you run a command such as npm install or pip install. \n\
...
var system_design = [{
  ...
  term: "Round Robin",
  description: "Requests are distributed across the group of servers sequentially. \n\
  ...
  description: "Developers practicing continuous integration merge their changes back to the main branch as often as possible. The developer's changes are validated by creating a build and running automated tests against the build. By doing so, you avoid integration challenges that can happen when waiting for release day to merge changes into the release branch.\n\n\
  ...
  description: "Continuous delivery is an extension of continuous integration since it automatically deploys all code changes to a testing and/or production environment after the build stage. \n\n\
  ...
  description: "The Ringelmann effect is the tendency for individual members of a group to become increasingly less productive as the size of their group increases\n\
...
}, // https://ganeshpr227.medium.com/key-concepts-and-terms-of-system-design-interview-notes-9bf882cf3730
{
  ...
  description: "the ability of a system to perform well despite some failures in the system.\n\n\
  ...
  term: "Availability",
  description: "A System is said to be available if it is operational. The availability of a system is the percentage it remains usable during its lifetime, excluding time for maintenance, repair, or other problems it might suffer.",
  ...
  term: "Sharding",
  description: "Sharding is a technique used to divide data into multiple smaller parts known as shards (Horizontal partitioning). These shards are not only smaller but faster and more manageable.",
...
decks.addDeck(new TermStorage(cloud, "cloud", {
  is_active: true
}));
decks.addDeck(new TermStorage(dataStructures, "data structures", {
  is_active: false
}));
