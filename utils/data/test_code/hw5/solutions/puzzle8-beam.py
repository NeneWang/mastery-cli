import copy
from p2_utils import priorityQueue, node, printResults, is_position_valid

movements = [(1, 0), (0, -1), (-1, 0), (0, 1)] # Movements for the empty tile

def solve(start, goal, beam_size =3,  max_depth=100):
    ...
    while not priorityQueue.empty():
        ...
        priorityQueue.trim(beam_width=beam_size)
        # print(pq.size()) # For debugging if the trim actually happens

    printResults(None, max_depth=max_depth, searches=searches)
